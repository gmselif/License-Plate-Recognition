...
for n=1:length(NewTemplates)
    cor=corr2(NewTemplates{1,n},snap); %The correlation coefficient is a number representing the similarity between 2 images in relation with their respective pixel intensity.
    rec=[rec cor];
end
